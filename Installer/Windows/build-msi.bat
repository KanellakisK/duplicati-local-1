...
echo ---****---***ΣΥΝΕΧΙΖΕΙ ΚΑΙ ΤΩΡΑ ΘΑ ΧΤΥΠΗΣΕΙ ΤΟ UpdateVersion.exe, ουτε με πληρη paths δε δουλευει---****---****
UpdateVersion.exe Duplicati.GUI.TrayIcon.exe UpgradeData.wxi     rem 'UpdateVersion.exe' is not recognized as an internal or external command, operable program or batch file.
rem Installer/Windows/UpdateVersion.exe Installer/Windows/Duplicati/Duplicati.GUI.TrayIcon.exe Installer/Windows/UpgradeData.wxi 
